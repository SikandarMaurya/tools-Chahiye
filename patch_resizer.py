...
content = re.sub(ai_toggle_old, ai_toggle_new, content)
...
content = re.sub(lock_old, lock_new, content)

# 3. Update Custom Width/Height Inputs (better borders and focus states for light/dark modes)
...
# 4. Update Select elements (better borders and focus states)
...
content = re.sub(select_mb4_old, select_mb4_new, content)
