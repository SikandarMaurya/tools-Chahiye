...
export const metadata: Metadata = {
  title: 'JPG to PDF Converter | ToolsChahiye',
  description: 'Convert JPG, PNG, and other images to PDF online for free.',
};
    ...
    <div className="min-h-screen bg-muted/30 pb-20">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-1">Easily convert your images to a single PDF file.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="border-2 border-dashed rounded-2xl p-16 text-center transition-all border-border bg-card hover:border-primary/50 hover:bg-muted/50 cursor-pointer">
          ...
          <h3 className="text-2xl font-semibold mb-2">Drag & Drop Images here</h3>
        ...
        <div className="mt-8 text-center text-muted-foreground p-6 bg-muted/30 rounded-xl border">
          <p className="text-sm">Client-side image to PDF processor is currently being restored. Interface placeholder active.</p>
        </div>
      </div>
    </div>
  );
