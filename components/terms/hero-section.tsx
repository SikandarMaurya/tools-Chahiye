...
export function HeroSection() {
  return (
    <section className="relative pt-32 pb-20 overflow-hidden border-b bg-muted/30">
      ...
      <div className="absolute top-0 left-0 -mt-20 -ml-20 w-96 h-96 bg-purple-500/10 blur-[100px] rounded-full pointer-events-none" />
      <div className="absolute bottom-0 right-0 -mb-20 -mr-20 w-80 h-80 bg-primary/10 blur-[100px] rounded-full pointer-events-none" />
      ...
      <div className="container mx-auto px-4 relative z-10 max-w-5xl">
        <div className="flex flex-col items-center text-center">
          ...
          >
            Please read these terms carefully before using our platform. By accessing our services, you agree to be bound by these rules.
          </motion.p>
